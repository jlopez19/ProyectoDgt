...
public class Reprocesar extends Activity {
	...
	private void inicializar() {
		...
		GestionDatos mygestiondatos = new GestionDatos(getApplicationContext());
		mygestiondatos.sentencias = this.sentencias;

	
		int cantUbicaciones = mygestiondatos.contarUbicacionesNoEnviadas();
		txtcantcomparendos.setText(" Numero de Viviendas:"+cantUbicaciones);
			...
			try{
				...
				for(int i=0;i<listaUbicaciones.length;i++){
					...
					UbicacionVivienda ubic=listaUbicaciones[i];
			     	 mypersistencia = new Persistencia(getApplicationContext(),sentencias);
		        	    mypersistencia.ubicacionVivienda=ubic;
		            	...
		            	mostrarMensaje("Enviado Ubicaciones "+r+" de "+listaUbicaciones.length,3);
